...
/**
* Set the angle of bus servo 1 to 8, range of 0~180 degree
*/
//% weight=99 blockId=qdee_setBusServo block="Set bus servo|port %port|index %index|angle(0~180) %angle|duration %duration"
